...
<div class="layout-with-sidebar">
    ...
    <div class="main-content">
        <div class="category-container">
            <!-- Bannière de la catégorie Nutrition -->
            <div class="category-banner nutrition-banner">
                <div class="banner-overlay">
                    <div class="banner-content">
                        <h1>🥗 Nutrition</h1>
                        <p>Partagez vos recettes, conseils nutritionnels et découvertes culinaires</p>
                    </div>
                </div>
            </div>
            ...
            <div class="category-content">
                <div class="category-header">
                    <h2>Publier dans la catégorie Nutrition</h2>
                    <p>Partagez vos recettes, conseils nutritionnels ou découvertes culinaires avec la communauté</p>
                </div>
                ...
                <div class="publication-form">
                    <form action="enregistrer_message.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" id="titre" name="titre" placeholder="Ex: Ma recette de smoothie protéiné matinal" required>
                        </div>

                        <div class="form-group">
                            <label for="description">Description :</label>
                            <textarea id="description" name="description" rows="6" placeholder="Décrivez votre recette, partagez vos conseils nutritionnels..." required></textarea>
                        </div>
                        ...
                        <input type="hidden" name="categorie" value="nutrition">
...
.nutrition-banner {
    background-image: url('https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1200&h=400&fit=crop');
}

...
<div class="layout-with-sidebar">
    ...
    <div class="main-content">
        <div class="category-container">
            <!-- Bannière de la catégorie Informatique -->
            <div class="category-banner informatique-banner">
                <div class="banner-overlay">
                    <div class="banner-content">
                        <h1>💻 Informatique</h1>
                        <p>Partagez vos connaissances en programmation, conseils tech et découvertes numériques</p>
                    </div>
                </div>
            </div>
            ...
            <div class="category-content">
                <div class="category-header">
                    <h2>Publier dans la catégorie Informatique</h2>
                    <p>Partagez vos tutoriels, conseils de programmation ou découvertes technologiques</p>
                </div>
                ...
                <div class="publication-form">
                    <form action="enregistrer_message.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" id="titre" name="titre" placeholder="Ex: Tutoriel Python - Créer une API REST" required>
                        </div>

                        <div class="form-group">
                            <label for="description">Description :</label>
                            <textarea id="description" name="description" rows="6" placeholder="Décrivez votre tutoriel, partagez vos conseils de programmation..." required></textarea>
                        </div>
...
.informatique-banner {
    background-image: url('https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=1200&h=400&fit=crop');
}

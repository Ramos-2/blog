...
<div class="layout-with-sidebar">
    ...
    <div class="main-content">
        <div class="category-container">
            <!-- Bannière de la catégorie Sport -->
            <div class="category-banner sport-banner">
                <div class="banner-overlay">
                    <div class="banner-content">
                        <h1>🏃‍♂️ Sport</h1>
                        <p>Partagez vos passions sportives, conseils d'entraînement et découvertes fitness</p>
                    </div>
                </div>
            </div>
            ...
            <div class="category-content">
                <div class="category-header">
                    <h2>Publier dans la catégorie Sport</h2>
                    <p>Partagez vos expériences sportives, conseils d'entraînement ou découvertes fitness avec la communauté</p>
                </div>
                ...
                <div class="publication-form">
                    <form action="enregistrer_message.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" id="titre" name="titre" placeholder="Ex: Ma routine d'entraînement matinal" required>
                        </div>

                        <div class="form-group">
                            <label for="description">Description :</label>
                            <textarea id="description" name="description" rows="6" placeholder="Décrivez votre expérience, partagez vos conseils..." required></textarea>
                        </div>
...
.sport-banner {
    background-image: url('https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=1200&h=400&fit=crop');
}
